...
EXPECTED_PROJECT_REPO_COMMIT = "96e91ab013c5669322ad59d556e671cbb3191229"
...
def test_stage05_notebook_forbidden_active_patterns_absent() -> None:
    ...
    # B6 + B7 are BUILT: documented as produced, never as deferred/uncomputed
    assert "05_multiplicity_discount.csv" in markdown_text
    assert "descriptive multiplicity discount" in markdown_text
    assert "05_selective_autopsy.csv" in markdown_text
    assert "abstention-by-activity-tercile" in markdown_text
