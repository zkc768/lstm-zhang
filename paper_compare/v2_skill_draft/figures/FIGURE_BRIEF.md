...
- **Evidence domains stay labeled and separate:** official validation (n=2 seeds)
  vs guarded non-independent walk-forward. The tercile figure shows both and
...
- **Content:**
  ...
  - Over the post-2017 span, draw the **guarded, non-independent walk-forward**
    as 7 consecutive period ticks (2017--2024). Label it "guarded (non-independent),
    not a clean test".
...
- **Caption already says:** filled squares are arithmetic means across seeds
  ...
  the guarded panel is a non-independent secondary descriptive analysis,
...
- **Labels:** legend "Validation" vs "Guarded WF", "Seed 101", "Seed 202", and
  ...
  Keep the full non-independent and not-clean-test limitation in the
...
- **Caption constraints:** say positive values favor the model; activity is the
  ...
  both domains; guarded is measure-only and non-independent, not a clean
