...
CELL_SPECS = [('markdown',
 ...
 ('code',
  ...
  '    import pandas as pd\n'
  '\n'
  '    summary_path = OUTPUT_DIR / "01_feature_window_search_summary.csv"\n'
  '    candidate_path = OUTPUT_DIR / "01_candidate_inputs.json"\n'
  '    ledger_path = OUTPUT_DIR / "01_train_inner_probe_ledger.csv"\n'
  '\n'
  '    for path in [summary_path, candidate_path, ledger_path]:\n'
  '        require_path(path)\n'
  '\n'
