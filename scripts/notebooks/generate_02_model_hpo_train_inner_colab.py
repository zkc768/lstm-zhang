...
CELL_SPECS = [
    ...
    (
        ...
        "    if len(matches) == 0:\n"
        "        uploaded = service.files().create(body={\"name\": local_path.name, \"parents\": [parent_id]}, media_body=media, fields=\"id, name, size, webViewLink\", supportsAllDrives=True).execute()\n"
        "        action = \"uploaded\"\n"
        "    elif len(matches) == 1:\n"
